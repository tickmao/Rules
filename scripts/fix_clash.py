...
text = text.replace("兜底分流", "NoAuto")

text = text.replace("⏱香港延迟优选", "Hong Kong")
text = text.replace("⏱美国延迟优选", "United States")
text = text.replace("⏱日本延迟优选", "Japan")
text = text.replace("⏱欧洲延迟优选", "Europe")
text = text.replace("🚥香港故障转移", "Hong Kong Fallback")
text = text.replace("🚥美国故障转移", "United States Fallback")
text = text.replace("🚥日本故障转移", "Japan Fallback")
text = text.replace("🚥欧洲故障转移", "Europe Fallback")
